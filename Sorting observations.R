...
#This R Tidyverse code snippet demonstrates how to sort a data frame named "class" based on 
#multiple variables, "Age" and "Height," in ascending and descending order, respectively, using the arrange function from the dplyr package. The sorted data frame is stored in a new data frame named "sorted."
